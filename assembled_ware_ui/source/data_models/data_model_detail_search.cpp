...
/// ############################################################################
///			class data_model_detail_search
/// ############################################################################
	...
	/// ========================================================================
	/// ------------------------------------------------------------------------
    ///	data_model_detail_search( )
	/// ------------------------------------------------------------------------
    data_model_detail_search::data_model_detail_search( QObject *pobj/* = 0*/ ) :
    ...
    ///	~data_model_detail_search( )
	/// ------------------------------------------------------------------------
    data_model_detail_search::~data_model_detail_search( )
	{
		this->clear( );

        qDebug( ) << "data_model_detail_search cleared correctly";
	}
	...
	///	ware( int i_row )
	/// ------------------------------------------------------------------------
    const data_ware* data_model_detail_search::ware( int i_row ) const
	{
	...
	///	clear( )
	/// ------------------------------------------------------------------------
    void data_model_detail_search::clear( )
	{
        if( !this->_list.size( ) )
        {
            return;
	...
	///	initialize( )
	/// ------------------------------------------------------------------------
    void data_model_detail_search::initialize( )
	{
	...
	/// ------------------------------------------------------------------------
    void data_model_detail_search::refresh(const QVector<QVector<QVariant> > &data)
	{
		this->clear( );
...
/*
	...
	/// ------------------------------------------------------------------------
    void data_model_detail_search::refresh( data_ware_collection *data )
	{
		this->clear( );
	...
	/// ------------------------------------------------------------------------
/*
    void data_model_detail_search::insert( const data_ware &request )
    {
    ...
    */
	...
	///	data( )
	/// ------------------------------------------------------------------------
    QVariant data_model_detail_search::data(
	...
	///	setData( )
	/// ------------------------------------------------------------------------
    bool data_model_detail_search::setData(
										const QModelIndex &/*index*/,
	...
	///	flags( )
	/// ------------------------------------------------------------------------
    Qt::ItemFlags data_model_detail_search::flags(const QModelIndex &/*index*/) const
	{
	...
	///	insertRows( )
	/// ------------------------------------------------------------------------
    bool data_model_detail_search::insertRows(
								int row, int count,
	...
	///	insertRows( )
	/// ------------------------------------------------------------------------
    bool data_model_detail_search::removeRows(
								int row, int count,
								const QModelIndex &parent //= QModelIndex( )
										 )
	{
