...
/// ############################################################################
    ...
    ///	data_model_ware( )
	/// ------------------------------------------------------------------------
    data_model_ware::data_model_ware( QObject *pobj/* = 0*/ ) :
    ...
    ///	~data_model_ware( )
	/// ------------------------------------------------------------------------
    data_model_ware::~data_model_ware( )
	{
		this->clear( );

        qDebug( ) << "data_model_ware cleared correctly";
	}
	...
	///	ware( int i_row )
	/// ------------------------------------------------------------------------
    const data_ware* data_model_ware::ware( int i_row ) const
	{
	...
	///	initialize( )
	/// ------------------------------------------------------------------------
    void data_model_ware::initialize( )
	{
	...
	/// ------------------------------------------------------------------------
    void data_model_ware::refresh(const QVector<QVector<QVariant> > &data)
	{
		this->clear( );
...
/*
	...
	/// ------------------------------------------------------------------------
    void data_model_ware::refresh( data_ware_collection *data )
	{
		this->clear( );
	...
	/// ------------------------------------------------------------------------
/*
    void data_model_ware::insert( const data_ware &request )
    {
    ...
    */
	...
	///	flags( )
	/// ------------------------------------------------------------------------
    Qt::ItemFlags data_model_ware::flags(const QModelIndex &/*index*/) const
	{
	...
	///	insertRows( )
	/// ------------------------------------------------------------------------
    bool data_model_ware::insertRows(
								int row, int count,
	...
	///	insertRows( )
	/// ------------------------------------------------------------------------
    bool data_model_ware::removeRows(
								int row, int count,
								const QModelIndex &parent //= QModelIndex( )
										 )
	{
