...
#ifndef __DATA_MODEL_WARE_SEARCH_H__
#define __DATA_MODEL_WARE_SEARCH_H__
...
/// ############################################################################
    class data_model_ware_search : public QAbstractTableModel
	{
	...
	public:
	/// ------------------------------------------------------------------------
        data_model_ware_search( QObject* pobj = 0 );
	/// ------------------------------------------------------------------------
        virtual ~data_model_ware_search( );
	...
	private:
	/// ------------------------------------------------------------------------
        data_model_ware_search& operator=( const data_model_ware_search &rhs );
...
#endif // __DATA_MODEL_WARE_SEARCH_H__
